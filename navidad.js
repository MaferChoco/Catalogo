const treeContainer = document.createElement("pre"); // Opcionalmente puedes eliminar esta línea si no usarás el árbol.
...
// createTree(12); // Eliminado o comentado para evitar que se genere el árbol.
createSnow(300); // Mantén la nieve.
